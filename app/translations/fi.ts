export const translationsFI = {
  ...
  commandHelpTitleCommand: "📖 Help => {{commandName}}",
  commandHelpTitlePage: "📖 Help > Page {{pageIndex}}",
  ...
  commandHelpPreviousPageWithIndex: "⏪ {{prefix}}help {{pageIndex}}",
  commandHelpNextPage: "Next page",
  commandHelpNextPageWithIndex: "⏩ {{prefix}}help {{pageIndex}}",
  ...
  commandChooseIChoose: "❓ I choose {{result}}",
  commandChooseMetaName: "Choose Option",
  commandChooseMetaDescription: "Choose a random option",

  commandCurrencyTitle: "💲 You have updated currency name",
  ...
  commandDailyTitle: "📅 + {{dailyTotal}} {{currencyName}}",
  ...
  commandFishingTitleBaits: "🎣 Fishing baits",
  ...
  commandIp: "🌐 Information for {{address}}",
  ...
  commandSlotMachineTitle: "🎰 Slotmachine",
  ...
  commandTopHead: "📝 Stats for __{{guildName}}__ in order **{{commandType}}**",
